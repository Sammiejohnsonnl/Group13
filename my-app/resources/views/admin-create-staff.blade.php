                            ...
                            <div class="form-group" id="role">
                                ...
                                <select class="form-control" name="role" id="role" required>
                                    ...
                                    <option value="Inventory Manager"
                                        {{ old('role') == 'Inventory Manager' ? 'selected' : '' }}>Inventory Manager
                                    </option>
                        ...
                        <div class="col mt-4">
                            <div class="form-group" id="branch">
                                ...
                                <select class="form-control" name="branch" id="branch" required>
                                    <option value="Sheffield" {{ old('branch') == 'Sheffield' ? 'selected' : '' }}>Sheffield
                                    </option>
                                    <option value="Derby" {{ old('branch') == 'Derby' ? 'selected' : '' }}>Derby</option>
                                    <option value="Leeds" {{ old('branch') == 'Leeds' ? 'selected' : '' }}>Leeds</option>
                                    <option value="Manchester" {{ old('branch') == 'Manchester' ? 'selected' : '' }}>
                                        Manchester</option>
